 ...
 * 
 * Usage:
 * 1. Place your logo image in public/img/logo.png (or update the source path below)
...
// Configuration
const sourceImage = path.join(__dirname, '../public/img/logo.png');
...
async function generateIcons() {
  ...
  if (!fs.existsSync(sourceImage)) {
    ...
    console.log('Please place your logo image at public/img/logo.png');
    process.exit(1);
  }
